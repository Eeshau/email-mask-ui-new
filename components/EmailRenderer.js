  ...
  return (
    ...
    />
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            className="textarea-floating px-[20px] py-[10px] mt-[10px]"
          />
      ...
      >
        ...
        >
          {showEMLPreview ? "Show Raw EML" : "Show to EML Preview"}
        </button>
        ...
        { postProofGeneration ? (
          <>
          <button
            onClick={() => setPostProofGeneration(false)}
            className="button font-sans flex items-center"
          >
            <span className="mr-2">
        ...
        >
          ...
          {postProofGeneration ? "Loading Proof" : "Generate Proof"}
        </button>
        )}
